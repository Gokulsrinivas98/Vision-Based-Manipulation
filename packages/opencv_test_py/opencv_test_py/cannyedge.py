...
class ImageSubscriber(Node):
  ...
  def cannyEdge(self,image):
    ...
    # self.publisher_.publish(self.br.cv2_to_imgmsg(mid, encoding="mono8")) Uncomment the line and comment the following three lines to get the image via image_view
    cv2.imshow("Canny Edge Map", mid)    
    cv2.waitKey(0)
